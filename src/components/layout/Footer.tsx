      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">SnackHub</span>
            </div>
            <p className="text-gray-400 text-sm">
              Tu marketplace favorito para encontrar los mejores snacks. 
              Conectamos a vendedores locales con amantes de los snacks.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} SnackHub. Todos los derechos reservados.
            </p>
